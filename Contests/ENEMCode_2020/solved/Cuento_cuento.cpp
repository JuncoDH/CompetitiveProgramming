...
int main(){
    ...
    while(tt--) {
        ...
        if(w) cout << B << " ha perdido :(\n";
        else cout << A << " ha perdido :(\n";


        //if(10 <= n && n <= 18) cout << A << " ha perdido :(\n";
        //else cout << B << " ha perdido :(\n";
        
        //n = (n+8)/9;

        //for(i = 34; i >= 0; i--) if(is_set(n, i)) break;
        //if(n != LSB(n)) i++;
        //if(i%2 == 1) cout << A << " ha perdido :(\n";
        //else cout << B << " ha perdido :(\n";
    }
